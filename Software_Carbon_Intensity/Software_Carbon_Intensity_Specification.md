...
1. **Scale**: The SCI is a rate, carbon emissions per one unit of a baseline called `R`. The next step is to pick the baseline which best describes how the application scales. 
