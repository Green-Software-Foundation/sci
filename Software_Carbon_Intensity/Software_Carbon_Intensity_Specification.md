...
- **Measure**: Calculate a rate, an SCI value, for every software component. The SCI value of the whole application is the average of the SCI values for every software component in the system.
